...
### Fixed
- **Clone Feature Not Found**: Memperbaiki error "Not Found" dengan mendaftarkan kembali rute dan tombol untuk fitur kloning Router dan Service.
...
- **History Cleanup**: Menambahkan fitur untuk membersihkan riwayat konfigurasi yang sudah diarsipkan dan lebih lama dari 30 hari.
...
### Added
- Menambahkan fitur pencarian pada halaman riwayat konfigurasi untuk memfilter berdasarkan nama pengguna.

## [2.2.9] - 2023-10-28

### Added
- Menambahkan fitur untuk membandingkan (diff) dua versi konfigurasi dari halaman riwayat.

## [2.2.8] - 2023-10-28

### Added
- Menambahkan tombol "Download" pada setiap baris di halaman riwayat, memungkinkan admin untuk mengunduh versi konfigurasi YAML tertentu.

## [2.2.6] - 2023-10-28

### Fixed
- Memperbaiki bug di mana data pada halaman riwayat konfigurasi tidak langsung muncul saat halaman dibuka.
...
### Added
- Menambahkan tombol "Restore" pada halaman riwayat konfigurasi, memungkinkan admin untuk mengembalikan seluruh pengaturan ke versi yang dipilih.
...
### Added
- Fitur riwayat konfigurasi: Setiap file YAML yang digenerate akan disimpan ke dalam tabel `config_history` di database.
...
### Changed
- Mengganti nama aplikasi dari "Config Manager" menjadi "Traefik Manager" di seluruh antarmuka dan dokumentasi.
